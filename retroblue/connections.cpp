...
BC127::opResult BC127::telephoneCallCommands(phoneCmds command, String number)
{
  switch(command)
  {    
    case CALL:
      return stdCmd("CALL " + number);
    default:
      return INVALID_PARAM;
  }
}

BC127::opResult BC127::telephoneCommands(phoneCmds command)
{

  switch(command)
  {
    case TOGGLE_VR:
      return stdCmd("TOGGLE_VR");
    case ANSWER:
      return stdCmd("ANSWER");
    case REJECT:
      return stdCmd("REJECT");
    case END:
      return stdCmd("END");
    default:
      return INVALID_PARAM;
