...
class BC127 
{
  public:
    ...
    enum phoneCmds {TOGGLE_VR, ANSWER, REJECT, CALL, END};
    ...
    opResult telephoneCommands(phoneCmds command);
    opResult telephoneCallCommands(phoneCmds command, String number);
